define(['./spotlight', 'imageLoader', 'focusManager', './../cards/cardbuilder', './../skininfo', 'emby-itemscontainer'], function (spotlight, imageLoader, focusManager, cardbuilder, skinInfo) {
    'use strict';
